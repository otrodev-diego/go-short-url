...
// Estructura para recibir la petición de crear URL corta
type shortenRequest struct {
	DTEID           string `json:"dte_id"`
	ExpireInMinutes int    `json:"expire_in_minutes"`
}

// Estructura para la respuesta de crear URL corta
type shortenResponse struct {
    ShortCode string `json:"short_code"`
    Token     string `json:"token"`
}

// Maneja las peticiones para crear URLs cortas
...
// Maneja las redirecciones a las URLs originales
